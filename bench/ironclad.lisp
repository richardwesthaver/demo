;;; ironclad.lisp --- Ironclad Benchmarks

;; 

;;; Code:
(in-package :demo/bench/ironclad)

(defparameter *lisp-implementations*
  `(("CORE" "core --load ironclad-impl.lisp")))
...
(defun write-result-file (results)
  (with-open-file (file *result-file* :direction :output :if-exists :supersede)
    ...
    (format file "Ironclad version: ~a~%~%" (std:version (std:find-system "ironclad")))
